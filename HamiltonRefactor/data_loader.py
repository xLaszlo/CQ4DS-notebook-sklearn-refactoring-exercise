...
import pandas as pd
from hamilton.function_modifiers import extract_columns, check_output, config
...
def raw_passengers_df__openml() -> pd.DataFrame:
    ...
    :return: dataframe of data.
    """
    base, targets = datasets.fetch_openml(
...
@extract_columns(
    "pclass", "sex", "age", "parch", "sibsp", "fare", "embarked", "name", "survived"
)
